...
public class TriggerProjectile : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Player") // Check if the object collided with has the tag "Player"
        {
            projectile.SetActive(true); // Trigger the projectile to move towards the player
